...
public class Controller {
    ...
    public void jsShowAllSeriesCharacters() {
        ...
        jsSeries.pwSecuenciac1(jsGetInt());
        System.out.println("");
        System.out.println("Secuencia 2: ");
        jsSeries.pwSecuenciac2(jsGetInt());
        System.out.println("");
        System.out.println("Secuencia 3: ");
        jsSeries.pwSecuenciac3(jsGetInt());
        System.out.println("");
        System.out.println("Secuencia 4: ");
        jsSeries.pwSecuenciac4(jsGetInt());
        System.out.println("");
        System.out.println("Secuencia 5: ");
        jsSeries.pwSecuenciac5(jsGetInt());
        System.out.println("");
        System.out.println("Secuencia 6: ");
        jsSeries.pwSecuenciac6(jsGetInt());
